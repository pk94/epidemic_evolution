...
public class ButtonsListener implements ActionListener {
	...
	final int buttonId;
	private boolean bool1=true, bool2=true, bool3=true, bool4 =true;

	public ButtonsListener(Lejaut appWindow, int buttonId) {
	...
	void startStopButtonOperations(){
		if (bool1 == true) {
			...
			appWindow.symulationPanel.animationStarter();
			//setEnabledFalse();
